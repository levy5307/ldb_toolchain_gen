...
cp -r -L /opt/exodus/bundles/*/lib/aarch64-linux-gnu/* toolchain/lib/

cp -r -L /opt/exodus/bundles/*/usr/lib/aarch64-linux-gnu/* toolchain/lib/

cp -L \
      /lib/aarch64-linux-gnu/libresolv.so.2 \
      /lib/aarch64-linux-gnu/libnss_nisplus.so.2 \
...
cp -L /usr/lib/aarch64-linux-gnu/libprofiler.so.0.4.8 toolchain/lib/libprofiler.so

gcc -shared -fPIC /disable_ld_preload.c -o toolchain/lib/disable_ld_preload.so -ldl

tar xzf /opt/patchelf-0.14.3-aarch64.tar.gz ./bin/patchelf --strip-components=2
...
for bin in toolchain/bin/*; do
    ./patchelf --set-interpreter "$PWD/toolchain/lib/ld-linux-aarch64.so.1" --set-rpath '$ORIGIN/../lib' "$bin"
done
...
tar xzf /opt/cmake-3.22.1-linux-aarch64.tar.gz --strip-components=1 --exclude='*/doc' --exclude='*/man' -C toolchain
...
cp -r --parents \
    ...
    /usr/include/aarch64-linux-gnu/bits/stropts.h \
    ...
    /usr/include/aarch64-linux-gnu/bits/xtitypes.h \
...
cp -L \
    ...
    /usr/lib/aarch64-linux-gnu/libcrypt.a \
    /usr/lib/aarch64-linux-gnu/libtinfo.a \
    /usr/lib/aarch64-linux-gnu/libtic.a \
    /usr/lib/aarch64-linux-gnu/libtermcap.a \
    /usr/lib/aarch64-linux-gnu/libssl.a \
    /usr/lib/aarch64-linux-gnu/libcrypto.a \
    /usr/lib/aarch64-linux-gnu/libnsl.a \
    toolchain/usr/lib/
...
#     echo "OUTPUT_FORMAT(elf64-littleaarch64)
# GROUP ( ./$lib.a )
...
for lib in libz libbfd libcrypt libtinfo libtic libtermcap libssl libcrypto libnsl; do
    cp -L /usr/lib/aarch64-linux-gnu/$lib.so toolchain/usr/lib/$lib.so
done
...
cp -L /usr/lib/aarch64-linux-gnu/crt1.o toolchain/usr/lib/
cp -L /usr/lib/aarch64-linux-gnu/crti.o toolchain/usr/lib/
cp -L /usr/lib/aarch64-linux-gnu/crtn.o toolchain/usr/lib/
cp -L /usr/lib/aarch64-linux-gnu/libc_nonshared.a toolchain/usr/lib/
cp -L /usr/lib/aarch64-linux-gnu/libpthread_nonshared.a toolchain/usr/lib/

cp -L /usr/lib/aarch64-linux-gnu/Mcrt1.o toolchain/usr/lib/
cp -L /usr/lib/aarch64-linux-gnu/Scrt1.o toolchain/usr/lib/
cp -L /usr/lib/aarch64-linux-gnu/gcrt1.o toolchain/usr/lib/

# static build
cp -L /usr/lib/aarch64-linux-gnu/libc.a toolchain/usr/lib/
cp -L /usr/lib/aarch64-linux-gnu/libpthread.a toolchain/usr/lib/
cp -L /usr/lib/aarch64-linux-gnu/libdl.a toolchain/usr/lib/
cp -L /usr/lib/aarch64-linux-gnu/librt.a toolchain/usr/lib/
cp -L /usr/lib/aarch64-linux-gnu/libresolv.a toolchain/usr/lib/
cp -L /usr/lib/aarch64-linux-gnu/libffi.a toolchain/usr/lib/
cp -L /usr/lib/aarch64-linux-gnu/libffi_pic.a toolchain/usr/lib/
...
cp -L /usr/lib/aarch64-linux-gnu/libm.a toolchain/usr/lib/libm-2.27.a
...
mkdir -p toolchain/lib/gcc/aarch64-linux-gnu/11

for f in /opt/exodus/bundles/*/usr/lib/gcc/aarch64-linux-gnu/11/*-x
do
    p=$(basename $f)
    g=${p::-2}
    cp -L $f toolchain/lib/gcc/aarch64-linux-gnu/11/$g
    ./patchelf --set-interpreter "$PWD/toolchain/lib/ld-linux-aarch64.so.1" --set-rpath '$ORIGIN/../../..' toolchain/lib/gcc/aarch64-linux-gnu/11/$g
done

cp -r -L /usr/lib/gcc/aarch64-linux-gnu/11/crtbegin.o \
         ...
         /usr/lib/gcc/aarch64-linux-gnu/11/libstdc++.a \
         /usr/lib/gcc/aarch64-linux-gnu/11/libstdc++fs.a \
         /usr/lib/gcc/aarch64-linux-gnu/11/libatomic.so \
         /usr/lib/gcc/aarch64-linux-gnu/11/libatomic.a \
         /usr/lib/gcc/aarch64-linux-gnu/11/liblto_plugin.so \
         /usr/lib/gcc/aarch64-linux-gnu/11/libgcov.a \
         /usr/lib/gcc/aarch64-linux-gnu/11/libsanitizer.spec \
         /usr/lib/gcc/aarch64-linux-gnu/11/libasan_preinit.o \
         /usr/lib/gcc/aarch64-linux-gnu/11/libasan.a \
         /usr/lib/gcc/aarch64-linux-gnu/11/libasan.so \
         /usr/lib/gcc/aarch64-linux-gnu/11/libtsan.a \
         /usr/lib/gcc/aarch64-linux-gnu/11/libtsan.so \
         /usr/lib/gcc/aarch64-linux-gnu/11/libubsan.a \
         /usr/lib/gcc/aarch64-linux-gnu/11/libubsan.so \
         /usr/lib/gcc/aarch64-linux-gnu/11/liblsan_preinit.o \
         /usr/lib/gcc/aarch64-linux-gnu/11/liblsan.a \
         /usr/lib/gcc/aarch64-linux-gnu/11/liblsan.so \
         /usr/lib/gcc/aarch64-linux-gnu/11/include \
    toolchain/lib/gcc/aarch64-linux-gnu/11

# gomp
cp -r -L \
    /usr/lib/gcc/aarch64-linux-gnu/11/crtfastmath.o \
    /usr/lib/gcc/aarch64-linux-gnu/11/libgomp.a \
    /usr/lib/gcc/aarch64-linux-gnu/11/libgomp.so \
    /usr/lib/gcc/aarch64-linux-gnu/11/libgomp.spec \
    toolchain/lib/gcc/aarch64-linux-gnu/11

for so in toolchain/lib/gcc/aarch64-linux-gnu/11/*.so
do
...
" >toolchain/lib/gcc/aarch64-linux-gnu/11/libstdc++.so

echo "/* GNU ld script
   Use the shared library, but some functions are only in
   the static library.  */
GROUP ( ../../../libgcc_s.so.1 -lgcc )
" >toolchain/lib/gcc/aarch64-linux-gnu/11/libgcc_s.so
...
echo "/* GNU ld script
   ...
   the static library.  */
GROUP ( -lgcc )
" >toolchain/lib/gcc/aarch64-linux-gnu/11/libgcc_s.a
...
mkdir -p toolchain/include/aarch64-linux-gnu/c++
mkdir -p toolchain/include/c++

cp -r /usr/include/aarch64-linux-gnu/c++/11 toolchain/include/aarch64-linux-gnu/c++/
