...
RUN exodus /usr/bin/python3 /usr/bin/curl /usr/bin/gdb /usr/bin/lldb-argdumper-13 /usr/bin/lldb-instr-13 /usr/bin/lldb-server-13 /usr/bin/lldb-vscode-13 /usr/bin/lldb-13 /usr/bin/clangd-13 /usr/bin/clang-tidy-13 /usr/bin/m4 /usr/bin/bison /usr/bin/yacc /usr/bin/flex /usr/bin/pkg-config /usr/bin/as /usr/bin/ld.bfd /usr/bin/clang-cpp-13 /usr/bin/aarch64-linux-gnu-cpp-11 /usr/bin/gcc-ranlib-11 /usr/bin/g++-11 /usr/bin/gcc-ar-11 /usr/bin/gcc-nm-11 /usr/bin/gcc-11 /usr/bin/llvm-objdump-13 /usr/bin/llvm-objcopy-13 /usr/bin/llvm-ranlib-13 /usr/bin/llvm-ar-13 /usr/bin/llvm-nm-13 /usr/bin/clang-13 /usr/bin/lld-13 /usr/bin/ninja /usr/lib/gcc/aarch64-linux-gnu/11/lto1 /usr/lib/gcc/aarch64-linux-gnu/11/lto-wrapper /usr/lib/gcc/aarch64-linux-gnu/11/g++-mapper-server /usr/lib/gcc/aarch64-linux-gnu/11/cc1 /usr/lib/gcc/aarch64-linux-gnu/11/cc1plus /usr/lib/gcc/aarch64-linux-gnu/11/collect2 | bash
